        ...
        <div class="row" style="padding-top: 20px; ">
            ...
            <div class="col-8">
                ...
                <div style="padding-top: 5px; ">
                    ...
                    <li><strong>Mitra: </strong> Menjaga jaringan pelanggan dan pemasok yang unggul, bersama menciptakan
                        nilai bersama yang mampu bertahan lama.</li>
                    <li><strong>Planet: </strong> Menjadi warga negara yang bertanggung jawab yang membuat perbedaan
                        dengan membantu membangun dan mendukung masyarakat yang berkelanjutan.</li>
                    <li><strong>Keuntungan: </strong> Memaksimalkan pengembalian jangka panjang kepada pemilik saham
