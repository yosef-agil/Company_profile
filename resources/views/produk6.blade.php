...
<body>
  ...
  <div class="row">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <img src="{{ ('assets/produk/minuman/sp.png') }}" class="d-block" alt="">
        </div>
      </div>
  ...
  <div class="col-2">
    ...
    <br><br>
    <p>Minuman Berkarbonasi Rasa Lemon dan Jeruk Nipis</p>
    <p>Diperkenalkan pada tahun 1961, Sprite adalah minuman ringan dengan aroma rasa lemon-jeruk terkemuka di dunia. 
      Sprite dijual di lebih dari 190 negara dan peringkat sebagai minuman ringan No. 3 di seluruh dunia.<br><br><br><br>
